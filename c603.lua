...
function s.ManifestCondition(e,c)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsCanRemoveCounter(tp,1,0,0x1b,3,REASON_COST)
end
...
function s.ConsumeCondition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetAttackTarget()~=nil and not e:GetHandler():GetEquipGroup():IsExists(s.efilter,1,nil)
end
...
function s.ConsumeOperation(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
