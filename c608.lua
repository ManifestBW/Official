...
function s.initial_effect(c)
	...
	--Defender Rule #3: Direct Interceptions (e4)
	...
	e14:SetRange(0,LOCATION_MZONE)
	e14:SetTargetRange(1,LOCATION_MZONE)
	e14:SetValue(s.AttackLimitation)
	c:RegisterEffect(e14)

	--Killer Rule #2 (e15)
	local e15=Effect.CreateEffect(c)
	e15:SetType(EFFECT_TYPE_SINGLE)
	e15:SetCode(EFFECT_CANNOT_DIRECT_ATTACK)
	...
	e16:SetValue(s.AttackLimitation)
...
function s.AnticipateOperation(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsCode(ac) and tc:IsType(TYPE_CONTINUOUS) then
...
--Killer Rules
function s.AttackLimitation(e,c)
	return not c:IsRace(0x10) and c:GetCounter(0x2e)<1
end